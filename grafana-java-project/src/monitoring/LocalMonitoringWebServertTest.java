...
public class LocalMonitoringWebServertTest {
	...
	private static String search = "[\"" + LocalMonitoringWebServertTest.MEMORY + "\",\"" + LocalMonitoringWebServertTest.CPU + "\"]";
	...
	public static void main(String[] args) throws IOException {
		...
		targetMap.put(LocalMonitoringWebServertTest.MEMORY, new ArrayList<GrafanaTimeseriePoint>());
		targetMap.put(LocalMonitoringWebServertTest.CPU, new ArrayList<GrafanaTimeseriePoint>());
